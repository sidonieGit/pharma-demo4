...
public class Statistique {
    ...
    // Médicaments les plus commandés : clé = Médicament, valeur = quantité totale
    // commandée
    ...
    public void afficher() {
        ...
        if (medicamentsLesPlusCommandes != null && !medicamentsLesPlusCommandes.isEmpty()) {
            medicamentsLesPlusCommandes.forEach((medoc, quantite) -> System.out
                    .println("  • " + medoc.getDesignation() + " : " + quantite + " unités"));
        } else {
